...
const heroes = [
    ...
    },
    {
        ...
        image: "https://i.ibb.co.com/VchWxmPg/download-13.jpg",
        quote:
...
const Heros = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 py-20 text-center">
            ...
            <motion.p
                className="max-w-3xl mx-auto text-neutral text-lg leading-relaxed mb-12"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {heroes.map((hero, index) => (
                    ...
                    >
                        ...
                        <div className="p-5">
                            <h3 className="text-lg font-bold text-primary mb-1">{hero.name}</h3>
